    ...
    return (
        <div>
            ...
            <div className="rounded-md shadow-md  dark:bg-gray-900 dark:text-gray-100">
              <div className="flex items-center justify-between p-3">
                <div className="flex items-center space-x-2">
                  ...
                  <div className="-space-y-1">
                    ...
                    <span className="inline-block text-xs leading-none dark:text-gray-400"> <p>{moment(date).fromNow()}</p></span>
                  </div>
                </div>
              ...
              <p>{text}</p>
              <img src={image} alt="" className="object-cover object-center w-[500px] h-[500px] dark:bg-gray-500" />
              <div className="p-3">
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    ...
                    <button type="button text-info" title="Share post" className="flex items-center justify-center">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 fill-current">
