...
const PostImages = ({ upload }) => {
  const { name, image, profilePic, date, text } = upload;
        ...
        <div className="p-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              {
                like ? <img src="https://www.freeiconspng.com/thumbs/heart-icon/valentine-heart-icon-6.png" className='w-5 h-5' alt="" />
                  :
